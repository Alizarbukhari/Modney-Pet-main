...
function Login({ setIsValid }) {
  ...
  return (
    <>
<div className="h-[1080px] w-[100%] bg-cover bg-center bg-[url('/bg-login.jpg')] relative">
  <div className='absolute top-[216px] left-0 right-0 flex justify-center items-center flex-col gap-24'>
